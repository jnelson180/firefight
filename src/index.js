...
// Set up game with our config
var game = new Phaser.Game(WINDOW_WIDTH, WINDOW_HEIGHT, Phaser.AUTO, '', config);
...
var player = {
    ...
    speed_x: 0, // This is the speed the player is currently moving at
    speed_y: 0, 
    speed: 0.5, // This is the parameter for how fast the player should move 
    friction: 0.95,
    shot: false, // Will be true when player is shooting
    update: function(){
...
function CreatePlayer(type, x, y, angle) {
    ...
    socket.on('update-players',function(players_data) {
        ...
        for(var id in players_data) {
            ...
            if (other_players[id] == undefined && id != socket.id) { // Make sure you don't create yourself
                ...
                var p = CreatePlayer(data.type, data.x, data.y, data.angle);
                other_players[id] = p;
