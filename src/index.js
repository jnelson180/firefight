...
function CreateShip(type,x,y,angle){
    ...
    var sprite = game.add.sprite(x,y,'player' + String(type) + '_1');
...
function preload(){
    ...
    // Load all the ships
    for(var i=1;i<=6;i++){
        game.load.image('player'+String(i) +'_1', ASSET_URL + 'player_handgun.png');
        // game.load.image('player'+String(i) +'_2', ASSET_URL + 'player'+String(i)+'_2.png');
        // game.load.image('player'+String(i) +'_3', ASSET_URL + 'player'+String(i)+'_3.png');
        // game.load.image('player'+String(i) +'_4', ASSET_URL + 'player'+String(i)+'_4.png');
    }
